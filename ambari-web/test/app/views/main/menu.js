...
App.MainMenuView = Em.CollectionView.extend({
  ...
  itemViewClass: Em.View.extend({
    ...
    isHostsItem: Em.computed.equal('content.routing', 'hosts'),
    isDashboardItem: Em.computed.equal('content.routing', 'dashboard'),
    isAlertsItem: Em.computed.equal('content.routing', 'alerts'),
    isViewsItem1: Em.computed.equal('content.routing', 'views'),
