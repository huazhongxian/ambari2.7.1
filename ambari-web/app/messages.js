...
Em.I18n.translations = {
 ...
 'login.error.bad.connection': '无法连接到 大数据平台 服务. 证实大数据平台服务器正在运行,你可以从这台机器到达Ambari服务器.',
 ...
 'installer.step7.popup.mySQLWarning.body': '你不能在同一主机上作为大数据平台 MySQL服务器的同时安装配置单元"新的MySQL数据库"服务。请返回<b>分配master</b>并重新分配蜂巢到另一台主机<b>或</b>选择"现有的MySQL数据库"选项来指定Ambari服务器的MySQL Server实例的数据库凭据和URL 。如果你选择"现有的MySQL数据库"选项,您需要执行Hive前提步骤准备MySQL服务器实例.',
